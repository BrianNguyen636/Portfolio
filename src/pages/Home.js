        ...
        <div>
            ...
            <div id="homeMain">
                ...
                <div id="homeText">
                    ...
                    <br/>
                    <a id = "homeButton" className="btn btn-primary" href="https://drive.google.com/file/d/1jY-sC2UUhBM0uqtsvUBsk0yqQcn365E8/view?usp=sharing" target="_blank">My Resume</a>
